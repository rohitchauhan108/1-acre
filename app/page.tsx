...
import { 
  Building2, ShieldCheck, MapPin, ArrowRight, Phone, 
  TrendingUp, Sparkles, ChevronDown, Check, X, Send,
  Star, Quote, UserCheck
} from 'lucide-react';

// Fallback high-res real estate images from Unsplash CDN
const FALLBACK_IMAGES: Record<string, string> = {
  'Residential Plots': 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?auto=format&fit=crop&w=800&q=80',
  'Luxury Villas': 'https://images.unsplash.com/photo-1613977257363-707ba9348227?auto=format&fit=crop&w=800&q=80',
  'Commercial Infrastructure': 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&w=800&q=80',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            >
              ...
              <h1 className="text-4xl sm:text-6xl font-light text-white leading-[1.15] tracking-tight">
                ...
                <span className="font-bold text-amber-400 italic font-serif">India Pvt Ltd</span>
              </h1>

              <p className="text-slate-300 text-base sm:text-lg leading-relaxed max-w-2xl">
                Dehradun&apos;s leading developer of 100% legal, clear-title freehold residential plots, hillside luxury villas, and high-street commercial developments across Sahastradhara Road, Rajpur Road, and Race Course.
              </p>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-2">
                <div className="bg-slate-900/90 p-3 rounded-xl border border-slate-800">
                  ...
                  <div className="text-[11px] text-slate-400 uppercase font-semibold">Acres Developed</div>
                </div>
                <div className="bg-slate-900/90 p-3 rounded-xl border border-slate-800">
                  <div className="text-2xl font-extrabold text-emerald-400">14</div>
                  <div className="text-[11px] text-slate-400 uppercase font-semibold">Gated Townships</div>
                </div>
                <div className="bg-slate-900/90 p-3 rounded-xl border border-slate-800">
                  <div className="text-2xl font-extrabold text-amber-400">850+</div>
                  <div className="text-[11px] text-slate-400 uppercase font-semibold">Plot Owners</div>
                </div>
                <div className="bg-slate-900/90 p-3 rounded-xl border border-slate-800">
                  <div className="text-2xl font-extrabold text-red-500">100%</div>
                  <div className="text-[11px] text-slate-400 uppercase font-semibold">Bank Approved</div>
                </div>
              </div>
              ...
              <div className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-4">
                <button
                  onClick={() => openInquiryModal('Book Free Dehradun Site Visit Pickup', 'Hero Section')}
            ...
            >
              <div className="border-b border-slate-800 pb-4">
                ...
                <p className="text-slate-400 text-xs mt-1">
                  Connect with Rakesh Sundriyal & Meenakshi Sundriyal for verified plot availability & legal diligence.
                </p>
              </div>
              ...
              <div className="space-y-3 text-xs">
                <div className="flex items-start gap-3 bg-slate-950/60 p-3 rounded-xl border border-slate-800">
                  ...
                  <div>
                    <span className="text-slate-400 block font-semibold">MD Rakesh Sundriyal:</span>
                    <a href={`tel:${COMPANY_INFO.directors[0].rawMobile}`} className="text-white font-bold text-sm hover:text-amber-400 transition-colors">
                ...
                <div className="flex items-start gap-3 bg-slate-950/60 p-3 rounded-xl border border-slate-800">
                  <Phone className="w-4 h-4 text-red-500 shrink-0 mt-0.5" />
                  <div>
                    <span className="text-slate-400 block font-semibold">MD Meenakshi Sundriyal:</span>
                    <a href={`tel:${COMPANY_INFO.directors[1].rawMobile}`} className="text-white font-bold text-sm hover:text-amber-400 transition-colors">
                ...
                <div className="flex items-start gap-3 bg-slate-950/60 p-3 rounded-xl border border-slate-800">
                  ...
                  <div>
                    <span className="text-slate-400 block font-semibold">Corporate Registration:</span>
                    <span className="text-emerald-400 font-mono font-bold text-xs">CIN: {COMPANY_INFO.cin}</span>
                  </div>
                </div>
              </div>

              <button
                onClick={() => openInquiryModal('Direct Director Consultation Request', 'Home Direct Desk')}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              ...
              <p className="text-slate-600 text-sm mt-1 max-w-xl">
                Explore premium freehold residential plots, hillside villas, and commercial spaces.
              </p>
            </div>

            {/* Quick Category Filter Pills */}
            <div className="flex items-center gap-2 flex-wrap">
              {['All', 'Residential Plots', 'Luxury Villas', 'Commercial Infrastructure'].map((cat) => (
                <button
                  key={cat}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredProjects.map((project, idx) => {
              const fallbackUrl = FALLBACK_IMAGES[project.category] || FALLBACK_IMAGES['default'];
              const imgSrc = project.image && project.image.startsWith('http') ? project.image : fallbackUrl;
              ...
              return (
                ...
                >
                    ...
                    <div className="p-6 space-y-4">
                      ...
                      <div className="bg-slate-50 p-3 rounded-xl border border-slate-100 text-xs space-y-1.5">
                        ...
                        <div className="flex justify-between text-slate-500 pt-1 border-t border-slate-200/60">
                          ...
                          <strong className="text-red-600 font-extrabold text-sm">{project.priceStarting} {project.priceUnit}</strong>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-6 pt-0 flex items-center gap-3">
                    ...
                    <button
                      onClick={() => openInquiryModal(`Inquiry for ${project.title}`, project.title)}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="text-center max-w-3xl mx-auto space-y-3">
            ...
            <p className="text-slate-400 text-sm">
              We eliminate title risks and infrastructure delays with 100% legal clarity.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {COMPANY_INFO.coreValues.map((val, idx) => (
              <div key={idx} className="bg-slate-950/80 p-6 rounded-2xl border border-slate-800 space-y-3">
          ...
          <div className="bg-white rounded-3xl p-8 sm:p-12 border border-slate-200 shadow-xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-4">
              ...
              <p className="text-slate-600 text-sm leading-relaxed">
                With travel time from Delhi reduced to just 2.5 hours via the new expressway, land values in Sahastradhara, Rajpur Road, and Race Course are projected to appreciate rapidly.
              </p>
              ...
              <div className="pt-2">
                ...
                >
                  <span>Explore Full Dehradun Infrastructure & Valuation Analysis</span>
                  <ArrowRight className="w-4 h-4" />
                </Link>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 bg-slate-950 text-white p-6 sm:p-8 rounded-2xl space-y-4 shadow-xl">
              ...
              <p className="text-slate-300 text-xs leading-relaxed">
                We provide complimentary chauffeur-driven vehicles to pick you up anywhere in Dehradun or Jolly Grant Airport to inspect plot demarcations and township layouts.
              </p>
              <button
                onClick={() => openInquiryModal('Book Free Cab Site Visit Pickup', 'Spotlight Teaser')}
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
    ...
    <div className="text-center max-w-2xl mx-auto space-y-2">
      ...
      <p className="text-slate-600 text-xs sm:text-sm">
        Read authentic experiences from defense officers, NRI investors, and local residents.
      </p>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      {TESTIMONIALS.map((t, index) => (
        <div 
          key={index} 
          className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm hover:shadow-md transition-all space-y-4 flex flex-col justify-between relative"
        >
          ...
          <div className="pt-4 border-t border-slate-100 flex items-center gap-3">
            <img
              ...
              alt={t.name}
              onError={(e) => {
                (e.target as HTMLImageElement).src = `https://i.pravatar.cc/150?img=${index + 10}`;
              }}
              className="w-10 h-10 rounded-full object-cover border border-slate-200"
            />
            <div className="flex-1 overflow-hidden">
              <div className="flex items-center gap-1">
                <strong className="text-slate-900 text-xs block font-bold truncate">{t.name}</strong>
                <UserCheck className="w-3.5 h-3.5 text-emerald-600 shrink-0" />
              </div>
              <span className="text-[11px] text-slate-500 block truncate">{t.designation}</span>
            </div>
          </div>
            ...
            {FAQS.map((faq, idx) => {
              ...
              return (
                <div key={idx} className="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-xs">
                  ...
                  >
                    <span>{faq.q}</span>
                    <ChevronDown className={`w-4 h-4 text-slate-500 transition-transform ${isOpen ? 'rotate-180 text-red-600' : ''}`} />
                  </button>
                  <AnimatePresence>
                    {isOpen && (
                      <motion.div
      ...
      <section className="py-16 bg-slate-950 text-white border-t border-slate-800">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          ...
          <p className="text-slate-300 text-xs sm:text-sm max-w-xl mx-auto">
            Contact Managing Director Rakesh Sundriyal directly or book a free cab site visit today.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              onClick={() => openInquiryModal('Book Free Dehradun Site Visit', 'Bottom Banner')}
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm">
            ...
            >
              <div className="bg-slate-950 text-white p-5 flex items-center justify-between border-b border-slate-800">
                <div>
                  <h3 className="font-bold text-sm text-amber-400">{modalTitle}</h3>
                  <span className="text-[10px] text-slate-400">Source: {modalSource}</span>
                </div>
                <button 
              ...
              {isSubmitted ? (
                <div className="p-8 text-center space-y-3">
                  ...
                  <p className="text-xs text-slate-600">Our team or Managing Director will contact you shortly.</p>
                </div>
              ) : (
                <form onSubmit={handleFormSubmit} className="p-6 space-y-4 text-xs">
                  ...
                  <div>
                    <label className="block font-bold text-slate-700 mb-1">Specific Requirements / Message</label>
                    <textarea
                      rows={3}
