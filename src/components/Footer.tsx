        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-slate-800">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <p className="text-slate-400 text-xs sm:text-sm leading-relaxed max-w-sm">
              One Acres Infra Heights India Private Limited is Dehradun&apos;s
              premier real estate & infrastructure developer. Delivering 100%
              legal freehold plots, luxury villas, and commercial plazas since
              2015.
            </p>
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <ul className="space-y-2.5 text-xs">
              <li>
                <Link
                  href="/projects/one-acres-green-valley-plots"
                  className="hover:text-red-400 transition-colors line-clamp-1"
                >
              ...
              <li>
                <Link
                  href="/projects/one-acres-himalayan-villas"
                  className="hover:text-red-400 transition-colors line-clamp-1"
                >
              ...
              <li>
                <Link
                  href="/projects/one-acres-corporate-plaza"
                  className="hover:text-red-400 transition-colors line-clamp-1"
                >
              ...
              <li>
                <Link
                  href="/projects/one-acres-race-course-heights"
                  className="hover:text-red-400 transition-colors line-clamp-1"
                >
              ...
              <li>
                <Link
                  href="/projects/one-acres-shimla-bypass-estates"
                  className="hover:text-red-400 transition-colors line-clamp-1"
                >
